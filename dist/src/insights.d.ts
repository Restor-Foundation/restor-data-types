...
export interface IInsightChapterDefinition {
    ...
    elements: (IAbstractInsightBrickResponse | IInsightTextElement | IInsightTitleElement | IInsightMapElement)[];
}
/**
 * Definition of a brick in the insights panel.
 */
export interface IAbstractInsightBrickResponse extends IInsightsElementDefinition {
    type: 'brick';
 ...
 */
export declare type IInsightsBrickResponse<BrickType extends IAbstractCalculationBrickType> = IAbstractInsightBrickResponse & BrickType['options'];
...
/** Calculation errors */
export declare enum CalculationErrorCode {
    NO_DATA = "NO_DATA",
...
export declare function isCalculationError(test: unknown | unknown[]): test is ICalculationErrorResult;
export {};
